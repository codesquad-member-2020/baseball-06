...
public class HalfInningQuery {
  ...
  public static final String FIND_BY_GAME_ID = "SELECT h.id, h.game_id, h.inning_index, h.type, h.score, h.end, h.created_at FROM half_inning h WHERE h.game_id = :game_id ORDER BY h.inning_index DESC";
  public static final String INSERT = "INSERT INTO half_inning (game_id, inning_index, type) VALUES (:game_id, :inning_index, :type)";
  public static final String UPDATE_END_TO_TRUE = "UPDATE half_inning SET end = true WHERE half_inning_id = :half_inning_id;";
}
