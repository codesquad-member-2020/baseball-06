...
public class HalfInningQuery {
  ...
  public static final String FIND_BY_GAME_ID_AND_LAST = "SELECT h.id, h.game_id, h.inning_index, h.type, h.score, h.end, h.created_at FROM half_inning h WHERE h.game_id = :game_id ORDER BY h.inning_index DESC";
